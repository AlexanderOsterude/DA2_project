...
merge_keys = ['STRIKE_DISTANCE', 'T', 'C_IV', 'C_DELTA']  

df_full = pd.read_csv("spy_longdated_calls_cleaned.csv")
df_full
df_test = pd.read_csv("df_test_predictions.csv")
df_test

df = df_test.merge(df_full, how='left', on=merge_keys)
df
